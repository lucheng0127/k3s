...
github_release() {
  ...
  giturl="https://github.moeyy.xyz/https://github.com/${owner_repo}/releases/${version}"
...
PLATFORM="${OS}/${ARCH}"
GITHUB_DOWNLOAD=https://github.moeyy.xyz/https://github.com/${OWNER}/${REPO}/releases/download
